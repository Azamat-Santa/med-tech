...
import './newManagerFormModal.css'



export default function NewManagerFormModal() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (patient) => {
      //   postNewDoctor(dispatch, patient);
      console.log(patient);
    },
  });

  return (
    <div className="modal-wrapper new-manager__wrapper"
    
    >
      <div className="patient-add-modal__content new-manager__content">
        ...
        <div className="patient-add__item">
          ...
          />
          {formik.errors.gestationalAge && formik.touched.gestationalAge && (
            <div style={{ color: "red" }}>{formik.errors.gestationalAge}</div>
          )}
        </div>
